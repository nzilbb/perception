...
%><%
   Page pg = (Page) request.getAttribute("page");
     ...
     pg.setTitle(pg.localizePattern("Define options for attribute ''{0}''", request.getParameter("attribute")));
     pg.addBreadCrumb("Participant Attributes", "attributes?task_id=" + request.getParameter("task_id"));
     pg.addBreadCrumb(pg.localizePattern("Options for ''{0}''", request.getParameter("attribute")));
%><c:set
     var="db_table" scope="request"
     ><db:table 
	 type="editdelete" insert="true" view="list"
	 inSituUpdates="true"
	 tableName="${module}_participant_attribute_option" title="${page.title}"
