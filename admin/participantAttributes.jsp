...
rs.close();
sql.close();
pg.addBreadCrumb("Participant Attributes");
%><c:set
     var="db_table" scope="request"
     ><db:table 
	 type="editdelete" insert="true" view="list"
	 tableName="${module}_participant_attribute_definition" title=""
	 inSituUpdates="true"
    ...
    <db:field
       ...
       />
    <db:field
       name="attribute" label="${resources['Attribute']}"
    ...
    <db:field
       ...
       />
    <db:link
       url="participantAttributeOptions"
